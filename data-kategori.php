...
<head>
  ...
  <title>App Toko | Data Kategori</title>
  <!-- Favicon -->
  ...
  <div class="page-flex">
    ...
    <div class="main-wrapper">
      ...
      <main class="main users chart-page" id="skip-target">
        <div class="section">
          <div class="container">
            <h2 class="main-title">Data Kategori</h2>
            <div class="box">
              <button
                style="background-color: #0061f7; color: #fff; padding: 10px;  border-radius: 10px; margin-bottom: 20px;"><a
                  href="tambah-kategori.php">Tambah Kategori</a></button>
