...
<body>
      ...
      <div class="search">
        <div class="container">
          <form action="produk.php">
            ...
            <input class="btn btn-get-started btn-get-started-blue text-white" type="submit" name="cari"
              value="Cari Aplikasi">
          </form>
        </div>
      </div>
  ...
  <div class="section" style="padding-top: 50px;">
    <div class="container">
      <h4 style="margin-bottom: 30px;">Kategori</h4>
      <div class="box">
        <?php 
  ...
  <div class="section">
    <div class="container">
      <h4 style="margin-bottom: 30px;">Aplikasi Terbaru</h4>
      <div class="box">
        <?php 
