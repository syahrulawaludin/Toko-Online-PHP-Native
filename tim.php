...
<body>
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0 px-md-5">
            ...
            <li class="nav-item">
              <a class="nav-link px-md-5 active" href="tim.php">Tim</a>
            </li>
          </ul>
          <div class="d-flex">
  ...
  <div class="container-xxl py-5">
    <div class="container py-5 px-lg-5">
      <h1 class="title-tim headline text-center mb-5" data-aos="fade-down" data-aos-duration="1000">App <span>Toko
        </span>Tim</h1>
    </div>
    <div class="row g-4 tim-card">
      <div class="col-lg-4 col-md-6">
        <div class="bg-light rounded" data-aos="fade-right" data-aos-duration="1000">
          <div class="text-center border-bottom p-4">
            <img class="img-fluid rounded-circle mb-4" src="img/tim/Yedi.jpeg" alt="" style="width: 60%;">
            <h5>Yedi Luqman</h5>
            <span>Content Writer | System Analyst</span>
          </div>
      ...
      <div class="col-lg-4 col-md-6">
        <div class="bg-light rounded" data-aos="fade-up" data-aos-duration="1000">
          <div class="text-center border-bottom p-4">
            <img class="img-fluid rounded-circle mb-4" src="img/tim/Syahrul.jpg" alt="" style="width: 60%;">
            <h5>Syahrul Awaludin</h5>
      ...
      <div class="col-lg-4 col-md-6">
        <div class="bg-light rounded" data-aos="fade-left" data-aos-duration="1000">
          <div class="text-center border-bottom p-4">
            <img class="img-fluid rounded-circle mb-4" src="img/tim/Khoerul.jpeg" alt="" style="width: 60%;">
            <h5>Khoerul Fazri</h5>
            <span>Conten Writer | Documenter</span>
          </div>
          <div class="d-flex justify-content-center p-4">
          </div>
        </div>
